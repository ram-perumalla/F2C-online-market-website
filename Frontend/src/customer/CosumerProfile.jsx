  ...
  >
    ...
    <dl className="mt-6 flex gap-4 sm:gap-6">
      <div className="flex flex-col-reverse">
        <dt className="text-sm font-medium text-gray-600">{user?.address}</dt>
        <dd className="text-xs text-gray-500">Address</dd>
      </div>
  
      <div className="flex flex-col-reverse">
        <dt className="text-sm font-medium text-gray-600">{user?.email}</dt>
        <dd className="text-xs text-gray-500">Email</dd>
      </div>
      <div className="flex flex-col-reverse">
        <dt className="text-sm font-medium text-gray-600">{user?.mobilenumber}</dt>
